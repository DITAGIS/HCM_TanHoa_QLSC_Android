...
public class Config {
    ...
    public Config(String url, String[] queryField, String[] outField, String title, int minScale) {
        this.url = url;
        this.queryField = queryField;
        this.outField = outField;
        this.title = title;
    ...
    public static class FeatureConfig {
        ...
        public static ArrayList<Config> getConfigs() {
            ...
            configs.add(new Config(Urls.url_dma, QueryFields.queryFields_dma, OutFields.outFields_dma, Title.title_dma, MinScale.minScale_dma));
            configs.add(new Config(Urls.url_van, QueryFields.queryFields_van, OutFields.outFields_van, Title.title_van, MinScale.minScale_van));
            configs.add(new Config(Urls.url_diemsuco, QueryFields.queryFields_diemsuco, OutFields.outFields_diemsuco, Title.title_diemsuco, MinScale.minScale_diemsuco));
            configs.add(new Config(Urls.url_donghotong, QueryFields.queryFields_donghotong, OutFields.outFields_donghotong, Title.title_donghotong, MinScale.minScale_donghotong));
            configs.add(new Config(Urls.url_ongnganh, QueryFields.queryFields_ongnganh, OutFields.outFields_ongnganh, Title.title_ongnganh, MinScale.minScale_ongnganh));
            configs.add(new Config(Urls.url_ongphanphoi, QueryFields.queryFields_ongphanphoi, OutFields.outFields_ongphanphoi, Title.title_ongphanphoi, MinScale.minScale_ongphanphoi));
            configs.add(new Config(Urls.url_ongtruyendan, QueryFields.queryFields_ongtruyendan, OutFields.outFields_ongtruyendan, Title.title_ongtruyendan, MinScale.minScale_ongtruyendan));
            configs.add(new Config(Urls.url_moinoi, QueryFields.queryFields_moinoi, OutFields.outFields_moinoi, Title.title_moinoi, MinScale.minScale_moinoi));
            configs.add(new Config(Urls.url_truhong, QueryFields.queryFields_truhong, OutFields.outFields_truhong, Title.title_truhong, MinScale.minScale_truhong));
            configs.add(new Config(Urls.url_diemapluc, QueryFields.queryFields_diemapluc, OutFields.outFields_diemapluc, Title.title_diemapluc, MinScale.minScale_diemapluc));
            configs.add(new Config(Urls.url_diemcuoiong, QueryFields.queryFields_diemcuoiong, OutFields.outFields_diemcuoiong, Title.title_diemcuoiong, MinScale.minScale_diemcuoiong));
            configs.add(new Config(Urls.url_donghokhachhang, QueryFields.queryFields_donghokhachhang, OutFields.outFields_donghokhachhang, Title.title_donghokhachhang, MinScale.minScale_donghokhachhang));
            return configs;
        }
    }
