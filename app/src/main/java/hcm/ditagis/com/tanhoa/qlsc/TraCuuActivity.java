...
private List<String> mLstFeatureType;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (parent.getItemAtPosition(position) instanceof hcm.ditagis.com.tanhoa.qlsc.adapter.FeatureViewMoreInfoAdapter.Item) {
            ...
            if (item.isEdit()) {
                ...
                builder.setPositiveButton("Cập nhật", new android.content.DialogInterface.OnClickListener() {
                    ...
                    public void onClick(android.content.DialogInterface dialog, int which) {
                        ...
                        new hcm.ditagis.com.tanhoa.qlsc.async.NotifyDataSetChangeAsync(TraCuuActivity.this).execute(adapter);
                    }
                });
