...
public class HoSoVatTuThuHoiSuCoDB implements IDB<HoSoVatTuSuCo, Boolean, String> {
    DateFormat formatter = new SimpleDateFormat("dd/MM/yyyy");
    private Context mContext;

    public HoSoVatTuThuHoiSuCoDB(Context mContext) {
    ...
    public Boolean delete(String s) {
        ...
        try {
            ...
            PreparedStatement deleteStatement = cnn.prepareStatement(mContext.getString(R.string.sql_delete_hosovattuthuhoi_suco));
    ...
    public List<HoSoVatTuSuCo> find(String idSuCo) {
        ...
        try {
            ...
            StrictMode.ThreadPolicy policy = new StrictMode.ThreadPolicy.Builder().permitAll().build();
            StrictMode.setThreadPolicy(policy);
            String query = mContext.getString(R.string.sql_select_hosovattuthuhoi_suco);
    ...
    public boolean insert(HoSoVatTuSuCo hoSoVatTuSuCo) {
        ...
        try {
            ...
            String query = mContext.getString(R.string.sql_insert_hosovattuthuhoi_suco);
