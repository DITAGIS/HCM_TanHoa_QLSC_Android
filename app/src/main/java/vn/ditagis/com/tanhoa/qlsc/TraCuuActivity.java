...
//        mServiceFeatureTable = new ServiceFeatureTable(getResources().getString(R.string.service_feature_table));
        ...
        if (parent.getItemAtPosition(position) instanceof vn.ditagis.com.tanhoa.qlsc.adapter.FeatureViewMoreInfoAdapter.Item) {
            ...
            if (item.isEdit()) {
                ...
                builder.setPositiveButton("Cập nhật", new android.content.DialogInterface.OnClickListener() {
                    ...
                    public void onClick(android.content.DialogInterface dialog, int which) {
                        ...
                        new vn.ditagis.com.tanhoa.qlsc.async.NotifyDataSetChangeAsync(TraCuuActivity.this).execute(adapter);
                    }
                });
