...
import vn.com.capnuoctanhoa.qlsc.libs.FeatureLayerDTG;
import vn.com.capnuoctanhoa.qlsc.socket.LocationHelper;
import vn.com.capnuoctanhoa.qlsc.socket.TanHoaApplication;
import vn.com.capnuoctanhoa.qlsc.tools.TraCuu;
import vn.com.capnuoctanhoa.qlsc.utities.Config;
import vn.com.capnuoctanhoa.qlsc.utities.ImageFile;
import vn.com.capnuoctanhoa.qlsc.utities.ListConfig;
import vn.com.capnuoctanhoa.qlsc.utities.MapViewHandler;
import vn.com.capnuoctanhoa.qlsc.utities.MySnackBar;
import vn.com.capnuoctanhoa.qlsc.utities.Popup;
...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(vn.com.capnuoctanhoa.qlsc.R.layout.activity_quan_ly_chat_luong_nuoc);
        startGPS();
        startSignIn();
    ...
    private void startGPS() {
        ...
        LocationListener listener = new LocationListener() {
            ...
            public void onLocationChanged(Location location) {
                mLocation = location;
                ((TanHoaApplication) MainActivity.this.getApplication()).setmLocation(mLocation);
            }
...
//                startActivity(i);
    ...
    private void initListViewSearch() {
        this.mListViewSearch = findViewById(vn.com.capnuoctanhoa.qlsc.R.id.lstview_search);
    ...
    private void setUp() {
        ...
        Toolbar toolbar = (Toolbar) findViewById(vn.com.capnuoctanhoa.qlsc.R.id.toolbar);
